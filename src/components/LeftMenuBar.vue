<template>
  ...
  <div id="nav-bar">
    ...
    <!-- 레프트바 헤더영역 -->
    <div id="nav-header">
      <div id="nav-header-up">
        <a id="nav-title" href="https://codepen.io" target="_blank">eSignyfy</a>
        <label @click = "fnWideTf()" for="nav-toggle"><span id="nav-toggle-burger"/></label>
      </div>
      <div id="nav-header-down">
        ...
        <div id = "nav-footer-iconbox-icon">
          <svg @click="logoutClick" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
